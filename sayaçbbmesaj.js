...
exports.run = async (client, message, args, prefix) => {
  ...
  const dbl = new DBL(`eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjcwMDYwODcwMjQyNzk1NTI3MCIsImJvdCI6dHJ1ZSwiaWF0IjoxNjA2OTQwNDkzfQ.fnvelJE1xf_MBqLCbS3pLdQPMwnWJSnD5564ROihGB0`,client)
    ...
    if(!args[0]) {
      ...
      .setColor("BLUE")
      .setDescription(`Merhaba, Öncelikle sayaç mesajı ayarlamak istiyorsan eğer bir değer belirtmelisin! örnek: ${prefix}sayaçbbmesaj ayarla veya ${prefix}sayaçbbmesaj sıfırla!`)
...
exports.help = {
    ...
    usage: "sayaçbbmesaj <ayarla <mesaj>/sıfırla>"
}