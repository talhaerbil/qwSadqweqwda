...
exports.run = async (client, message, prefix, args) => {
    ...
    .setDescription(`
    • | Daha detaylı bilgi almak için emojilere tıklamanız yeterlidir.
    ...
    • | [Davet](https://discord.com/oauth2/authorize?client_id=${client.user.id}&scope=bot&permissions=8) - [Oy](https://top.gg/bot/${client.user.id}/vote) - [YouTube](https://youtube.com/c/WhYBoLu) - [Destek](${client.ayarlar.destek}) - [WebSite](${client.ayarlar.website}) - [Sponsor](https://martihost.com/) | •
    `)
