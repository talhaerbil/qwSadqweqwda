    ...
    Promise.all(promises).then(results => {
      ...
      if(message.channel.nsfw === true) {
        ...
        **●▬▬▬▬▬▬▬▬【 Bilgilendirme 】▬▬▬▬▬▬▬▬▬●**
        ...
        • | Şuanda anlık olarak **${sunucu.toLocaleString()}** Adet sunucuya ve **${kullanıcı.toLocaleString()}** Adet kullanıcıya hizmet veriyorum!
        • | ${bilgi[bilgiler]}
    
        **●▬▬▬▬▬▬▬▬【 Hakkımızda 】▬▬▬▬▬▬▬▬▬●**
        • | **${client.ayarlar.botİsim}** Botu **TheClawNz#6717** Tarafından sizler için yapılmıştır ;)
        • | **2019 Ekim** Ayında yapılmaya başlandım.
